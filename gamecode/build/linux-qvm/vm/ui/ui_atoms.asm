...
;24:}
LABELV $88
endproc Com_Error 2056 12
export Com_Printf
proc Com_Printf 2056 12
line 26
;25:
...
;381:	*x = *x * uiInfo.uiDC.scale + uiInfo.uiDC.biasX;
ADDRLP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 382
;382:	*y = *y * uiInfo.uiDC.scale + uiInfo.uiDC.biasY;
ADDRLP4 4
ADDRFP4 4
INDIRP4
ASGNP4
...
line 387
;386:
;387:void UI_DrawNamedPic( float x, float y, float width, float height, const char *picname ) {
line 390
;388:	qhandle_t	hShader;
;389:
;390:	hShader = trap_R_RegisterShaderNoMip( picname );
ADDRFP4 16
INDIRP4
ARGP4
ADDRLP4 4
...
ASGNI4
line 391
;391:	UI_AdjustFrom640( &x, &y, &width, &height );
ADDRFP4 0
ARGP4
ADDRFP4 4
ARGP4
...
pop
line 392
;392:	trap_R_DrawStretchPic( x, y, width, height, 0, 0, 1, 1, hShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
line 395
;394:
;395:void UI_DrawHandlePic( float x, float y, float w, float h, qhandle_t hShader ) {
line 401
;396:	float	s0;
;397:	float	s1;
;398:	float	t0;
;399:	float	t1;
;400:
;401:	if( w < 0 ) {	// flip about vertical
ADDRFP4 8
INDIRF4
CNSTF4 0
GEF4 $283
...
line 411
;410:
;411:	if( h < 0 ) {	// flip about horizontal
ADDRFP4 12
INDIRF4
CNSTF4 0
GEF4 $285
...
pop
line 422
;422:	trap_R_DrawStretchPic( x, y, w, h, s0, t0, s1, t1, hShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
;427:UI_FillRect
;428:
;429:Coordinates are 640*480 virtual values
;430:=================
;431:*/
;432:void UI_FillRect( float x, float y, float width, float height, const float *color ) {
line 433
;433:	trap_R_SetColor( color );
ADDRFP4 16
INDIRP4
ARGP4
...
line 435
;434:
;435:	UI_AdjustFrom640( &x, &y, &width, &height );
ADDRFP4 0
ARGP4
ADDRFP4 4
ARGP4
...
pop
line 436
;436:	trap_R_DrawStretchPic( x, y, width, height, 0, 0, 0, 0, uiInfo.uiDC.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
line 441
;440:
;441:void UI_DrawSides(float x, float y, float w, float h) {
line 442
;442:	UI_AdjustFrom640( &x, &y, &w, &h );
ADDRFP4 0
ARGP4
ADDRFP4 4
ARGP4
...
pop
line 443
;443:	trap_R_DrawStretchPic( x, y, 1, h, 0, 0, 0, 0, uiInfo.uiDC.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
pop
line 444
;444:	trap_R_DrawStretchPic( x + w - 1, y, 1, h, 0, 0, 0, 0, uiInfo.uiDC.whiteShader );
ADDRFP4 0
INDIRF4
ADDRFP4 8
INDIRF4
...
line 447
;446:
;447:void UI_DrawTopBottom(float x, float y, float w, float h) {
line 448
...
pop
line 449
;449:	trap_R_DrawStretchPic( x, y, w, 1, 0, 0, 0, 0, uiInfo.uiDC.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
pop
line 450
;450:	trap_R_DrawStretchPic( x, y + h - 1, w, 1, 0, 0, 0, 0, uiInfo.uiDC.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
;457:=================
;458:*/
;459:void UI_DrawRect( float x, float y, float width, float height, const float *color ) {
line 460
...
line 462
;461:
;462:  UI_DrawTopBottom(x, y, width, height);
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
pop
line 463
;463:  UI_DrawSides(x, y, width, height);
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
line 468
;467:
;468:void UI_SetColor( const float *rgba ) {
line 469
;469:	trap_R_SetColor( rgba );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 trap_R_SetColor
...
line 472
;471:
;472:void UI_UpdateScreen( void ) {
line 473
;473:	trap_UpdateScreen();
...
;475:
;476:
;477:void UI_DrawTextBox (int x, int y, int width, int lines)
;478:{
line 479
;479:	UI_FillRect( x + BIGCHAR_WIDTH/2, y + BIGCHAR_HEIGHT/2, ( width + 1 ) * BIGCHAR_WIDTH, ( lines + 1 ) * BIGCHAR_HEIGHT, colorBlack );
ADDRFP4 0
INDIRI4
CNSTI4 8
ADDI4
...
pop
line 480
;480:	UI_DrawRect( x + BIGCHAR_WIDTH/2, y + BIGCHAR_HEIGHT/2, ( width + 1 ) * BIGCHAR_WIDTH, ( lines + 1 ) * BIGCHAR_HEIGHT, colorWhite );
ADDRFP4 0
INDIRI4
CNSTI4 8
ADDI4
...
line 484
;482:
;483:qboolean UI_CursorInRect (int x, int y, int width, int height)
;484:{
line 485
;485:	if (uiInfo.uiDC.cursorx < x ||
ADDRLP4 0
ADDRFP4 0
INDIRI4
ASGNI4
...
LABELV $308
line 489
;486:		uiInfo.uiDC.cursory < y ||
;487:		uiInfo.uiDC.cursorx > x+width ||
;488:		uiInfo.uiDC.cursory > y+height)
;489:		return qfalse;
CNSTI4 0
RETI4
ADDRGP4 $299
