...
EQI4 $55
line 20
;20:		G_Printf( "G_Alloc of %u bytes (%u left)\n", size, POOLSIZE - allocPoint - ( ( size + 31 ) & ~31U ) );
ADDRGP4 $58
ARGP4
ADDRLP4 4
ADDRFP4 0
...
LEU4 $59
line 24
;24:		G_Error( "G_Alloc: failed on allocation of %u bytes", size );
ADDRGP4 $61
ARGP4
ADDRFP4 0
INDIRU4
...
line 40
;40:	G_Printf( "Game memory status: %u out of %u bytes allocated\n", allocPoint, POOLSIZE );
ADDRGP4 $64
ARGP4
ADDRGP4 allocPoint
INDIRU4
